...
<img src="https://render.githubusercontent.com/render/math?math=\displaystyle \phi = -H \exp\left(\frac{z}{H}\right)J_0(left(\frac{r}{H}\right) \qquad \psi = r \exp\left(\frac{z}{H}\right)J_1left(\frac{r}{H}\right)">
