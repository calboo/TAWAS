# TAWAS
An idl script for solving the wave equation for torsional Alfven waves in a viscous plasma in static equilibrium with an axisymmetric, force-free magnetic field with no azimuthal component. This wave equation is:
...
Where u is the angular velocity of the Alfven wave, <img src="https://render.githubusercontent.com/render/math?math=\displaystyle \rho"> is the density, <img src="https://render.githubusercontent.com/render/math?math=\displaystyle \mu_0">is the vacuum permeability and <img src="https://render.githubusercontent.com/render/math?math=\displaystyle \nu"> is the kinematic viscosity.. The solution is calculated using the analytical formula presented in NAMEOFPAPER. 
